...
class PaginationService {
    ...
    // RequestStack gère la pile de requêtes (quand il y a des "forward" par exemple)
    /**
    ...
    public function getPages(): int {
        if(empty($this->entityClass)) {
            throw new Exception("Vous n'avez pas spécifié l'entité sur laquelle nous devons parginer ! Utiliser la méthode setEntityClass de la méthode PaginationService");
        }
        $results = count($this->manager
    ...
    public function getData(): array {
        ...
        $offset = ($this->currentPage - 1) * $this->limit; // ou page * limit - limit 
